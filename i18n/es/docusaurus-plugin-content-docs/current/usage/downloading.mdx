...
Para más información, echa un ojo a [servicio de reconstrucción](/core/services#reconstruction-service)
...
Para una lista completa de los métodos auxiliares echa un ojo a: [pipelines](/core/pipelines)
También a [DeltaPlan](/core/interfaces#DeltaPlan)
